...
public class Expression {
	...
	public Expression cast(Class<?> destType) {
		...
		return new Expression("(" + ClassHelper.makeClassName(destType) + ")("
	...
	public Expression box(Class<?> destClazz) {
		...
		if (!ClassHelper.isNeedBox(originClazz, destClazz)) {
			return this;
		}
	...
	public Expression unboxOrZero(Class<?> destClazz) {
		Class<?> originClazz = getType();
		if (!ClassHelper.isNeedUnbox(originClazz, destClazz)) {
			return this;
		}
