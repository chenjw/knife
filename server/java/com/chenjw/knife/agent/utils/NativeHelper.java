...
public class NativeHelper {
  ...
  public static void loadNativeLibrary(String libName) {
    ...
    File tmpFile = null;
    try {
      is = NativeHelper.class.getResource("/" + libName + suffix).openStream();
  ...
  public static void setStaticFieldValue(Class<?> clazz, Field field, Object value) {
    if (field == null) {
  ...
  private native static void redefineClass0(Class<?> clazz, byte[] newClassBytes);
  ...
  private native static Object getFieldValue0(Object obj, Class<?> fieldClass, String name,
      Class<?> returnType);

  // ///////////////////////////////////////////////
  // set field
  // ///////////////////////////////////////////////
  private native static void setObjectFieldValue0(Object obj, Field field, Object newValue);

  private native static void setBooleanFieldValue0(Object obj, Field field, boolean newValue);

  private native static void setByteFieldValue0(Object obj, Field field, byte newValue);

  private native static void setCharFieldValue0(Object obj, Field field, char newValue);

  private native static void setShortFieldValue0(Object obj, Field field, short newValue);

  private native static void setIntFieldValue0(Object obj, Field field, int newValue);

  private native static void setLongFieldValue0(Object obj, Field field, long newValue);

  private native static void setFloatFieldValue0(Object obj, Field field, float newValue);

  private native static void setDoubleFieldValue0(Object obj, Field field, double newValue);

  // ///////////////////////////////////////////////
  // set static field
  // ///////////////////////////////////////////////
  private native static void setStaticObjectFieldValue0(Class<?> clazz, Field field,
      Object newValue);

  private native static void setStaticBooleanFieldValue0(Class<?> clazz, Field field,
      boolean newValue);

  private native static void setStaticByteFieldValue0(Class<?> clazz, Field field, byte newValue);

  private native static void setStaticCharFieldValue0(Class<?> clazz, Field field, char newValue);

  private native static void setStaticShortFieldValue0(Class<?> clazz, Field field, short newValue);

  private native static void setStaticIntFieldValue0(Class<?> clazz, Field field, int newValue);

  private native static void setStaticLongFieldValue0(Class<?> clazz, Field field, long newValue);

  private native static void setStaticFloatFieldValue0(Class<?> clazz, Field field, float newValue);

  private native static void setStaticDoubleFieldValue0(Class<?> clazz, Field field,
      double newValue);
  ...
  // get static field
  // ///////////////////////////////////////////////
  private native static Object getStaticObjectFieldValue0(Class<?> clazz, Field field);

  private native static boolean getStaticBooleanFieldValue0(Class<?> clazz, Field field);

  private native static byte getStaticByteFieldValue0(Class<?> clazz, Field field);

  private native static char getStaticCharFieldValue0(Class<?> clazz, Field field);

  private native static short getStaticShortFieldValue0(Class<?> clazz, Field field);

  private native static int getStaticIntFieldValue0(Class<?> clazz, Field field);

  private native static long getStaticLongFieldValue0(Class<?> clazz, Field field);

  private native static float getStaticFloatFieldValue0(Class<?> clazz, Field field);

  private native static double getStaticDoubleFieldValue0(Class<?> clazz, Field field);
  ...
  private static void classLoaded(Class<?> clazz) {
    if (clazz.getClassLoader() == null) {
      ...
      if (printer != null) {
        printer
            .debug("[LOAD] " + clazz + " loaded by " + clazz.getClassLoader().getClass().getName());
      }
    }
  ...
  private static void do3() {
    ...
    t.setCpu("cpu");
    System.out.println(NativeHelper.findInstancesByClass(ThreadInfo.class)[0].getCpu());
  ...
  private static void do1() throws ClassNotFoundException {
    ...
    for (int i = 0; i < objs.length; i++) {
      System.out.println(
          counts[i] + " " + objs[i] + " " + NativeHelper.findReferreeByObject0(objs[i]).length);
