...
public class ProxyMethodFilter implements Filter {
	...
	public ProxyMethodFilter() {
		String[] patternStrs = new String[] { "org.springframework.aop.*",
				"net.sf.cglib.*", "java.lang.reflect.Method.invoke",
	 ...
	 * @return
	 */
	private boolean isMatch(Object thisObject, String className,
			String methodName) {
		String cName;
		if (thisObject != null) {
