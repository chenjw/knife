...
public class LinkAdapter extends Link {
  ...
  public boolean equals(Object obj) {
    ...
    if (Profiler.METHOD_NAME_ENTER.equals(name)) {
      ...
      Profiler.leave(args[1], (String) args[2], (String) args[3], (Object[]) args[4], args[5]);
      ...
      Profiler.returnEnd(args[1], (String) args[2], (String) args[3], (Object[]) args[4], args[5]);
    ...
    } else if (Profiler.METHOD_NAME_NEW_OBJECT.equals(name)) {
      Profiler.newObject(args[1], (String) args[2], (String) args[3], (Object[]) args[4]);
    } else if (Profiler.METHOD_NAME_NEW_ARRAY.equals(name)) {
      Profiler.newArray(args[1], (String) args[2]);
    }
    return false;
  }
