...
public class StubProfilerTemplate implements ProfilerTemplate {
  ...
  public void init() {
    ...
    CtMethod ctMethod =
        JavassistHelper.findCtMethod(classGenerator.getCtClass(), StubProfilerTemplate.METHOD);
    ...
    methodGenerator.addExpression(
        "if(($1 instanceof com.sun.corba.se.spi.presentation.rmi.DynamicStub)||($1 instanceof org.omg.CORBA.portable.ObjectImpl)){return true;}");
    methodGenerator.addExpression(
        "if($1 instanceof Object[]){ sun.awt.image.ImageWatched.endlink.equals((Object[])$1) ;}");
