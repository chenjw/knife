 ...
 * include the License file at nbbuild/licenses/CDDL-GPL-2-CP. Oracle designates this particular
 * file as subject to the "Classpath" exception as provided by Oracle in the GPL Version 2 section
 * of the License file that accompanied this code. If applicable, add the following below the
 * License Header, with the fields enclosed by brackets [] replaced by your own identifying
...
class HeapHistogram1 {
 ...
 public  static boolean initialize() {
  ...
  public static void main(String[] args) throws IOException {
    HeapHistogram1.initialize();
    String str = IOHelper.toString(HeapHistogram1.getRawHistogram(), "utf-8");
