...
jvmtiIterationControl JNICALL iterate_markTag(jlong class_tag, jlong size,
...
void JNICALL eventHandlerClassFileLoadHook(jvmtiEnv * jvmti, JNIEnv * env,
...
void JNICALL eventHandlerClassLoadedHook(jvmtiEnv * jvmti, JNIEnv* env, jthread thread,
		jclass klass) {
